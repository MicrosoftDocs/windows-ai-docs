...
The Windows File Explorer connector provides a set of tools to access and modify files using a Model Conext Protocol (MCP) server.

The connector provides access to common user folders including Documents, Desktop, Downloads, Music, Videos and Pictures, as well as public folders on the device.
