...
2. [Windows ML](./windows-ml/index.md): a way for you to build and bring your own models
...
## Choosing between Windows Copilot Runtime APIs or building your own models with Windows ML

lorem ipsum

## Using Cloud AI Models instead of Windows Copilot Runtime
...
When a local AI model is the right solution, you can use [Windows Copilot Runtime](./apis/index.md) APIs to integrate AI services for users on Copilot+ PCs. A few of these ready-to-use AI features that you can tap into from your Windows app include:
