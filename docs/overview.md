...
1. [Windows AI APIs](apis/index.md): Use built-in Windows AI APIs to integrate AI services into your Windows apps. These APIs include the following:
    ...
    - Customizations: Fine-tune the [Phi Silica model](./apis/phi-silica.md) with Low Rank Adaptation ([LoRA](./apis/apis/phi-silica-lora.md)) and index in-app content to make it searchable through exact keywords and semantic meaning ([App Content Search](./apis/app-content-search.md)).
