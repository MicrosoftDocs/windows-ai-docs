---
title: Get started with  Windows AI Foundry
...
# Get started with Windows AI Foundry
...
3. [Windows ML](windows-ml/index.md): a way for you to build and bring your own models
4. [Windows App Actions](actions/index.md): create actions for your app enabling new and unique AI capabilities for consumers
5. Dev Tools: tooling such as Visual Studio AI Toolkit and AI Dev Gallery that will help you be successful building AI capabilities
...
## Choosing between Windows AI APIs, Foundry Local models or Bringing your own model

lorem ipsum

## Using Cloud AI Models instead of Windows AI Foundry
...
When a local AI model is the right solution, you can use [Windows AI Foundry](./apis/index.md) APIs to integrate AI services for users on Copilot+ PCs. A few of these ready-to-use AI features that you can tap into from your Windows app include:
