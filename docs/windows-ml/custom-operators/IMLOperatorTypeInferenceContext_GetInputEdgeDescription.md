...
description: Learn about the IMLOperatorTypeInferenceContext.GetInputEdgeDescription method. This method gets the description of the specified input edge of the operator.
ms.date: 4/1/2019
ms.topic: article
