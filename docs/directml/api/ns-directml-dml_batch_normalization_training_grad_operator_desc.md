...
description: Computes backpropagation gradients for [batch normalization training](api/ns-directml-dml_batch_normalization_training_operator_desc.md).
...
Computes backpropagation gradients for [batch normalization training](api/ns-directml-dml_batch_normalization_training_operator_desc.md).
...
A tensor containing the input data. This is typically the same tensor that was provided as the *InputTensor* to [**DML_BATCH_NORMALIZATION_TRAINING_OPERATOR_DESC**](api/ns-directml-dml_batch_normalization_training_operator_desc.md) in the forward pass.
...
A tensor containing the mean data. This is typically the same tensor that was returned by *MeanTensor* from [**DML_BATCH_NORMALIZATION_TRAINING_OPERATOR_DESC**](api/ns-directml-dml_batch_normalization_training_operator_desc.md) in the forward pass.

`VarianceTensor`

Type: **const [DML_TENSOR_DESC](/windows/win32/api/directml/ns-directml-dml_tensor_desc)\***

A tensor containing the variance data. This is typically the same tensor that was returned as the *OutputVarianceTensor* from [**DML_BATCH_NORMALIZATION_TRAINING_OPERATOR_DESC**](api/ns-directml-dml_batch_normalization_training_operator_desc.md) in the forward pass. 
