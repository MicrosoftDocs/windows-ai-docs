...
If you already have a model and wants to convert it to ONNX, we recommend installing the latest version of the [winmltools](convert-model-winmltools.md) package, which supports the 1.2.2 format.
