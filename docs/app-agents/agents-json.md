---
title: Agent definition JSON schema for App Agents on Windows
...
TBD - This section is copy/pasted from the action JSON manifest and needs to be updated to the agent manifest.
