...
To see the release history of EPs, see [Windows ML execution providers](./supported-execution-providers.md) and expand the "Release history" section underneath each available EP.

To check what version of EP a device has, see [Check Windows ML EP versions](./versioning.md).
