...
The following tables clarify which ONNX Runtime (ORT) version or commit was shipped with each Windows ML package release.
...
|--|--|--|--|
| `2.4.89` | 9/22/2026 | [`1.27.1`](https://github.com/microsoft/onnxruntime/releases/tag/v1.27.1) | 7/10/2026 |
