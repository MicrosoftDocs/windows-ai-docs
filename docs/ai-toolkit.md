...
<!--
> [!NOTE]
> You should know your GPU's compute capability. You can find this information on the [CUDA GPUs](https://developer.nvidia.com/cuda-gpus) page. AI Toolkit requires a GPU with a compute capability of 6.1 or higher. If you don't have a compatible GPU, you can still use the extension to browse the AI models catalog and download models, but you won't be able to fine-tune them.
-->
