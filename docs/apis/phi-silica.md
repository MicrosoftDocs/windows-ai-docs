...
For GPU driver requirements, see [GPU driver requirements](#gpu-driver-requirements).
...
- **AMD Radeon**: [AMD Software: Adrenalin Edition 26.10.2 driver](https://www.amd.com/en/resources/support-articles/release-notes/RN-RAD-WIN-26-10-02-01-DXCGC.html)
