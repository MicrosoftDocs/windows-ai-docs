...
Jump to the **WCR APIs** tab to try out the APIs. Navigate to the **models** tab to download the Phi model (such as Phi 3.5 Mini). Learn more about the [AI Dev Gallery](../ai-dev-gallery/index.md).
