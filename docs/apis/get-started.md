...
1. Add the following to your .waproj, .csproj, or .vcxproj file. This step is necessary if you're creating a visual studio project to ensure visual studio doesn't override the max version tested.
