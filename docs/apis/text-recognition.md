...
In this example we call a `LoadImageBufferFromFileAsync` function to get an [ImageBuffer](text-recognition-api-ref.md) from an image file.
...
1. Return an image buffer from [CreateBufferAttachedToBitmap](text-recognition-api-ref.md).
...
1. Using the bitmap obtained in the previous snippet, we call the [RecognizeTextFromSoftwareBitmap](text-recognition-api-ref.md) function.
1. Call [CreateBufferAttachedToBitmap](text-recognition-api-ref.md) on the image file to get an [ImageBuffer](text-recognition-api-ref.md) object.
1. Call [RecognizeTextFromImage](text-recognition-api-ref.md) to get the recognized text from the [ImageBuffer](text-recognition-api-ref.md).
