...
#### [Enable TensorFlow with DirectML on WSL 2](directml/gpu-tensorflow-wsl.md)
#### [Enable TensorFlow with DirectML on Windows](directml/gpu-tensorflow-windows.md)
...
##### [DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC](directml/api/ns-directml-dml_batch_normalization_training_grad_operator_desc.md)
##### [DML_BATCH_NORMALIZATION_TRAINING_OPERATOR_DESC](directml/api/ns-directml-dml_batch_normalization_training_operator_desc.md)
...
##### [DML_ELEMENT_WISE_CLIP_GRAD1_OPERATOR_DESC](directml/api/directml/ns-directml-dml_element_wise_clip_grad1_operator_desc)
##### [DML_ELEMENT_WISE_CLIP_OPERATOR_DESC](/windows/win32/api/directml/ns-directml-dml_element_wise_clip_operator_desc)
##### [DML_ELEMENT_WISE_CLIP1_OPERATOR_DESC](directml/api/directml/ns-directml-dml_element_wise_clip1_operator_desc)
...
##### [DML_ELEMENT_WISE_NEGATE_OPERATOR_DESC](directml/api/directml/ns-directml-dml_element_wise_negate_operator_desc)
...
##### [DML_PADDING1_OPERATOR_DESC](directml/api/directml/ns-directml-dml_padding1_operator_desc)
...
##### [DML_ROI_ALIGN_GRAD_OPERATOR_DESC](directml/api/ns-directml-dml_roi_align_grad_operator_desc.md)
