...
##### [DML_ELEMENT_WISE_CLIP_GRAD1_OPERATOR_DESC](directml/api/ns-directml-dml_element_wise_clip_grad1_operator_desc.md)
##### [DML_ELEMENT_WISE_CLIP_OPERATOR_DESC](/windows/win32/api/directml/ns-directml-dml_element_wise_clip_operator_desc)
##### [DML_ELEMENT_WISE_CLIP1_OPERATOR_DESC](directml/api/ns-directml-dml_element_wise_clip1_operator_desc.md)
...
##### [DML_ELEMENT_WISE_NEGATE_OPERATOR_DESC](directml/api/ns-directml-dml_element_wise_negate_operator_desc.md)
...
##### [DML_PADDING1_OPERATOR_DESC](directml/api/ns-directml-dml_padding1_operator_desc.md)
