...
##### [DML_BATCH_NORMALIZATION_TRAINING_GRAD_OPERATOR_DESC](api/ns-directml-dml_batch_normalization_training_grad_operator_desc.md)
##### [DML_BATCH_NORMALIZATION_TRAINING_OPERATOR_DESC](api/ns-directml-dml_batch_normalization_training_operator_desc.md)
...
##### [DML_ROI_ALIGN_GRAD_OPERATOR_DESC](api/ns-directml-dml_roi_align_grad_operator_desc.md)
